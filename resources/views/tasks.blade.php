    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div data-signals="{title: '', tasks: {{ json_encode($tasks) }}, errors: {}}">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div data-show="$tasks.length > 0" class="space-y-3">
                    <template data-for="task in $tasks">
                        <div>
                            ...
                            <div data-show="!$['editing_' + task.id]" class="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                                ...
                                <input 
                                    type="checkbox"
                                    data-attr:checked="task.is_completed"
                                ...
                                <span 
                                    ...
                                    data-style:text-decoration="task.is_completed ? 'line-through' : 'none'"
                                    class="flex-1">
                                </span>
                                ...
                                <button 
                                    type="button"
                                    data-on:click="$['editing_' + task.id] = true; $['editTitle_' + task.id] = task.title"
                            ...
                            <div 
                                ...
                                <input 
                                    type="text"
                                    data-attr:id="'edit-input-' + task.id"
                                    data-attr:value="task.title"
                                    autofocus
